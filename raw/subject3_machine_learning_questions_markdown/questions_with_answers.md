# AI 應用規劃師（中級）科目 3：機器學習技術與應用 — 練習題擷取

Source: `AI應用規劃師(中級)-學習指引-科目3機器學習技術與應用_20251222101907.pdf`

Extracted practice questions: 40 questions total, 10 questions per chapter. Images: none in the extracted question sections.
