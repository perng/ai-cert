...
model = models.Sequential([
    # 卷積層 1：32 個 3x3 濾鏡，ReLU 活化函數，輸入形狀 28x28x1 (如 MNIST)
...
*   **經典模型**：
    *   **VGG (Visual Geometry Group)**：
        ...
        *   **優勢**：
            *   **參數更少**：堆疊兩個 3x3 卷積層的感受野 (Receptive Field) 等同於一個 5x5 卷積層，但參數數量更少 ($2 \times 3^2 = 18$ vs $1 \times 5^2 = 25$)。
...
*   **代表模型**：
    *   **YOLO (You Only Look Once)**：
        ...
        *   **運作流程**：
            1.  **網格劃分 (Grid Division)**：將輸入影像劃分為 $S \times S$ 的網格。
